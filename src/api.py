...
class APIEngine:
    def __init__(self):
        ...
        glasses_config = types.GenerateContentConfig(
            system_instruction="You are an assistant built into a pair of glasses. Always keep your responses to a one or two, brief sentence so the user doesn't have to listen to long audio playbacks. Never use conversational openings or closings. You're located in Sulaymaniyah, Iraq."
        )
